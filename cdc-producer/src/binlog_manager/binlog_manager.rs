...
impl BinLogManager {
    ...
    fn inner_run(&mut self, resume: &Option<Resume>, init: bool) -> Result<(), Error> {
        if init {
    ...
    fn send_current_file_records(&mut self) -> Result<(), Error> {
    ...
    fn send_all_files_records(&mut self) -> Result<(), Error> {
...
mod test {
    ...
    const BL_INDEX: &'static str = "binlog.index";
    const BL_FILE1: &'static str = "binlog.000001";
    const BL_FILE2: &'static str = "binlog.000002";
